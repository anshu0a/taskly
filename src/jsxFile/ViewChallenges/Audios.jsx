...
export default function VoicePlayer({ voice }) {
    ...
    return (
        <div className='outdiver isFlex'>
            <div ref={waveRef} className='voceControl' />
            <div className='bbtton isFlex' onClick={() => wsRef.current.playPause()}>
                {isPlaying ?
                    <svg className="figg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    :
                    <svg className="figg" viewBox="0 0 24 24" >
